# Generated by Django 2.2.16 on 2020-10-16 00:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label', models.CharField(max_length=256, verbose_name='Axis Name')),
                ('type', models.CharField(choices=[('linear', 'linear'), ('logarithmic', 'logarithmic'), ('category', 'category'), ('time', 'time'), ('radial', 'radial')], max_length=10, verbose_name='Axis Type')),
        ...
        migrations.AddField(
            model_name='datasetmodel',
            name='xAxis',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='datasetmodel_xAxis', to='djangocms_charts.AxisModel'),
        ),
        migrations.AddField(
            model_name='datasetmodel',
            name='yAxis',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='datasetmodel_yAxis', to='djangocms_charts.AxisModel'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='chartmodel',
            name='xAxis',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='chartmodel_xAxis', to='djangocms_charts.AxisModel'),
        ),
        migrations.AddField(
            model_name='chartmodel',
            name='yAxis',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='chartmodel_yAxis', to='djangocms_charts.AxisModel'),
        ),
        migrations.AddField(
            model_name='axismodel',
            name='options',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='axis_options', to='djangocms_charts.AxisOptionsGroupModel'),
        ),
    ]
